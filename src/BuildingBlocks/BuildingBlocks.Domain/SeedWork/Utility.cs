...
namespace BuildingBlocks.Domain.SeedWork
{
    public static class DateTimeUtility
    {
        ...
        public static DateTime GetDateTimeUTC => SystemClock.Instance.GetCurrentInstant().ToDateTimeUtc();

        public static long GetCurrentUnixUTCTimeMilliseconds()
        {
            long unixTimeMilliseconds = new Instant().ToUnixTimeMilliseconds();
